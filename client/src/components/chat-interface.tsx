...
export function ChatInterface() {
  ...
  return (
    <div className="chat-container flex flex-col h-screen">
      ...
      <div className="flex-1 flex items-center justify-center p-2 sm:p-2 md:p-4 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
        <div className="desktop-wide w-full max-w-xs sm:max-w-sm rounded-3xl shadow-xl border border-slate-200 flex flex-col" style={{height: "calc(100vh - 2rem)", backgroundColor: '#E5F1F2'}}>
          {/* Header with Logo */}
