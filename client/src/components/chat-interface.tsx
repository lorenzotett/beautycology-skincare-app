...
export function ChatInterface() {
    ...
    return (
      <div className="chat-container flex flex-col h-screen">
        ...
        <div className="flex-1 flex items-center justify-center p-2 sm:p-2 md:p-4 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
          <div className="w-full max-w-xs sm:max-w-sm md:max-w-full space-y-4 md:space-y-6 text-center rounded-3xl p-6 md:p-8 shadow-xl border border-slate-200" style={{backgroundColor: '#E5F1F2'}}>
            {/* Logo Bonnie */}
  ...
  return (
    <div className="chat-container flex flex-col h-screen">
      ...
      <div className="flex-1 flex items-center justify-center p-2 sm:p-2 md:p-4 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
        <div className="w-full max-w-xs sm:max-w-sm md:max-w-full rounded-3xl shadow-xl border border-slate-200 flex flex-col" style={{height: "calc(100vh - 2rem)", backgroundColor: '#E5F1F2'}}>
          {/* Header with Logo */}
